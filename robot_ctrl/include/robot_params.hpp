...
// matlab:   -0.5344    4.4747  -12.0389    8.7028   16.6731  -14.2722   25.3489  长连杆
// 新matlab：  -3.1762   38.3970 -184.8731  453.9609 -593.4035  408.7483  -85.6488 短连杆
const float dia2mechAngelCoeff[7] = {
    -0.5344  ,  4.4747 , -12.0389 ,   8.7028 ,  16.6731 , -14.2722  , 25.3489 
...
const float push_out_length_mid[2] = {10.0f , 45.0f}; // 推杆伸出长度范围，单位mm

const float TIGHT_LENGTH_LIMIT[2] = {47.0f , 58.0f};  // 夹紧长度范围
